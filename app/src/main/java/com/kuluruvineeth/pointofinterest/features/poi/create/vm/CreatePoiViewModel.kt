package com.kuluruvineeth.pointofinterest.features.poi.create.vm
...
import com.kuluruvineeth.pointofinterest.features.categories.ui.models.toDomainModel
import com.kuluruvineeth.pointofinterest.features.categories.ui.models.toUiModel
import com.kuluruvineeth.pointofinterest.features.poi.create.models.*
...
class CreatePoiViewModel @Inject constructor(
    ...
    private val _wizardSuggestionState = MutableStateFlow<WizardSuggestionUiState>(
    ...
    fun onSkip() {
        ...
        _screenState.value =
            CreatePoiScreenState.Form(WizardSuggestionUiModel(url = sharedContent.content))
    }
