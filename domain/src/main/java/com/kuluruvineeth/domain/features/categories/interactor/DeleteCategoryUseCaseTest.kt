...
class DeleteCategoryUseCaseTest {
    ...
    @Test
    fun test_delete_category_use_case_invokes_deleteCategory_repo_function() =
        runTest {
            val id = "id"
    ...
    fun test_delete_category_use_case_throws_exception_when_deleteCategory_throws_exception() = runTest {
        val id = "id"
